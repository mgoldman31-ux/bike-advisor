...
public class RideCharacter {
    ...
    public double getAggressionIndex() { return aggressionIndex; }
    public void setAggressionIndex(double aggressionIndex) { this.aggressionIndex = aggressionIndex; }

    public double getHandlingIndex() { return handlingIndex; }
    public void setHandlingIndex(double handlingIndex) { this.handlingIndex = handlingIndex; }
